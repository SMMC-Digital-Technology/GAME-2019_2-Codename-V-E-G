...
var menuState = {
   create: function() {
     title = game.add.text(game.world.centerX, game.world.centerY-100, 'Codename-V-E-G', ) {font: '50px Arial', fill: '#0000'});
     title.anchor.setTo(0.5, 0.5);

     help = game.add.text(80, game.world.centerY+50, 'text', {font: '25px Arial', fill: '#0000'});
